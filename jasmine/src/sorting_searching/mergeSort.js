/**
 * Merge Sort
 * @see http://quiz.geeksforgeeks.org/merge-sort/
 ...
 * The merge() function is used for merging two halves. The merge(arr, l, m, r) is key process
